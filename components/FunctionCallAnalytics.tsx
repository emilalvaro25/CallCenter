...
const FunctionCallAnalytics: React.FC = () => {
  ...
  // FIX: Explicitly type the accumulator for the reduce function to ensure type safety. This fixes errors on lines 31 and 38.
  const functionCallCounts = turns.reduce<Record<string, number>>((acc, turn) => {
